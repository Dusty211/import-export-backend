...
job_options = [
  ...
  {job_id: all_jobs[2].id, morality: -5, criminality: 8, option_text: "I didn't see anything... I will be out getting pancakes later. That would be a good time to load the cargo."},
  {job_id: all_jobs[2].id, morality: -8, criminality: 8, option_text: "Bro, I have a tee time in like 30 minutes. Can you get to the point? *you fan through the 100-stack you've been fiddling with*"},
  {job_id: all_jobs[2].id, morality: 10, criminality: -10, option_text: "You're that guy I saw on 60 Minutes. I'm calling the police."},
  {job_id: all_jobs[2].id, morality: -10, criminality: 5, option_text: "I know who you are. You're a legend, man. This one's on the house."}
]
